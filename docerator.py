...
# Resources
DEFAULT_BACKGROUND = '/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/GenericDocumentIcon.icns'  # might require leopard? Nope, it doesn't, works fine in 10.4.
